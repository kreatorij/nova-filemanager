<template>
    <div class="flex items-center justify-start" :class="class" style="min-height: auto">
        <template v-if="field.type == 'image'">
            <img class="h-full w-full" :src="field.image" style="object-fit: contain" :style="{
                'max-width': field.maxWidth || 'auto'
            }" />
        </template>
        ...
        <template v-else-if="field.type == 'video'">
            <video ref="video" controls crossorigin playsinline :style="{
                'max-width': field.maxWidth || 'auto'
            }">
